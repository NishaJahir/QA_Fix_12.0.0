...
class NovalnetGooglePayButtonDataProvider
{
                         ...
                         $arg)
    {
        ...
        $googlePayData = [
            ...
            'MerchantId' => $settingsService->getNnPaymentSettingsValue('payment_active', 'novalnet_google_pay'),
            'sellerName' => $settingsService->getNnPaymentSettingsValue('business_name', 'novalnet_google_pay'),
